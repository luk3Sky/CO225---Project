...
public class FractalExplorer extends JFrame{    //inherit JFrame
    /*
...
// -------------------------------------------------------------------
    private int computeIterations_2(double z_r, double z_i) {
...
// -------------------------------------------------------------------
    public static void main(String[] args) {
        new FractalExplorer();  //creating a new instance of Fractal
    }
